    ...
    <div className='alll'>
      <div>
        <div className='block'>
          ...
          <NavLink to={"/all"}><button className='game-button3'>Выставить свой товар &#707;</button></NavLink>
        </div>
        <div className="card-list2">
          {cardsToShow.map((card) => (
            <NavLink key={card.id} to={`/product/${card.id}`} className="product-card-link">
              <div className="product-card2">
                ...
                <img src={card.image} alt={card.title} className="product-logo1" />
